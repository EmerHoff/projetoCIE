...
public class OtherNames implements BerType, Serializable {
	...
	private BerPrintableString values = null;
	
	public OtherNames() {
	}

	public OtherNames(byte[] code) {
		this.code = code;
	}
	...
	public void setValues(BerPrintableString values) {
		this.values = values;
	}

	public BerPrintableString getValues() {
		return values;
	}
