...
public class OtherAttribute implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static class Value implements BerType, Serializable {
	...
	public byte[] code = null;
	private BerObjectIdentifier type = null;
	private Value value = null;
	
	public OtherAttribute() {
	}

	public OtherAttribute(byte[] code) {
		this.code = code;
	}

	public void setType(BerObjectIdentifier type) {
		this.type = type;
	}

	public BerObjectIdentifier getType() {
		return type;
	}
