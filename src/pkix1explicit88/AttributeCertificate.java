...
public class AttributeCertificate implements BerType, Serializable {
	...
	private BerBitString signatureValue = null;
	...
	public void setSignatureValue(BerBitString signatureValue) {
		this.signatureValue = signatureValue;
	}

	public BerBitString getSignatureValue() {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += signatureValue.encode(reverseOS, true);
		
		codeLength += signatureAlgorithm.encode(reverseOS, true);
		
		codeLength += acinfo.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(AttributeCertificateInfo.tag)) {
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (acinfo != null) {
			sb.append("acinfo: ");
			acinfo.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("acinfo: <empty-required-field>");
		}
		...
		if (signatureValue != null) {
			...
			sb.append("signatureValue: <empty-required-field>");
		}
